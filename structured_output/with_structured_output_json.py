# disclaimer, this code runs with openai, gemini but not with huggingface models 
...
json_schema = {
  ...
  "properties": {
    "key_themes": {
      "type": "array",
      "items": { "type": "string" },
      "description": "Write all key themes of review"
    },
    "summary": {
      "type": "string",
      "description": "Write summary of review"
    },
    "sentiment": {
      "type": "string",
      "enum": ["pos", "neg"],
      "description": "Provide sentiment"
    },
    "pros": {
      "type": ["array", "null"],
      "items": { "type": "string" },
