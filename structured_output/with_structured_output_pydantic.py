# disclaimer, this code runs with openai, gemini but not with huggingface models as function calling is not supported
...
class Review(BaseModel):
    key_themes: list[str] = Field(description = " Write all key themes of review")
    summary: str = Field(description = " Write summary of the given review")
    sentiment: Literal["pos", "neg"] = Field(description = "provide sentiment of the review")
    pros: Optional[list[str]] = Field(default = None, description = "Write all pros of review")
    cons: Optional[list[str]] = Field(default = None, description = "Write all conss of review")
    name: Optional[str] = Field(default = None, description = "write name of the person who gave review")
